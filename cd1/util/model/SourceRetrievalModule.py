...
class SourceRetrievalModule(pl.LightningModule):
    def __init__(self, _config):
        ...
        #weight=torch.FloatTensor(_config['class_weighting']),
        self.ids = []
        self.results = []
    ...
    def forward(self, input_ids, attention_mask, labels=None):
        # outputs = self.model(input_ids=input_ids, patch_images=patch_images, patch_masks=patch_masks, attention_mask=attention_mask, decoder_input_ids=decoder_input_ids)
        
        # print(f"input_ids : {input_ids}")
        # print(f"patch_images : {patch_images}")
    ...
    def test_epoch_end(self, outputs: EPOCH_OUTPUT) -> None:
        ...
        df.to_csv('/home2/yangcw/pred_false.csv', index=False)
